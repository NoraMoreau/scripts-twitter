document.addEventListener("DOMContentLoaded", () => {
    ...
    async function arretSuppression(bouton) {
        ...
        console.log("ARRET FORCEE DE LA SUPPRESSION, VARIABLE LOCALE VIDEES, CLASSE ACTIVEBOUTON REMOVE");      
    }
    ...
    async function lancerScriptSupp() {
        ...
        let boutons_suppression = document.querySelectorAll('.bouton_lancer_suppression');
